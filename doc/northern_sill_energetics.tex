...
Driven by the density anomaly and associated pressure drop across the sill, the flow is relatively steady as apparent in the repeat sections presented in this study and in moored observations at several points along the flow presented in a previous paper.
...
The strongly sheared and highly stratified upper overflow interface thus acts as a critical layer and inhibits any appreciable upward radiation of energy via topographically generated internal lee waves.
Form drag of $\mathcal{O}(2)$\,N\,m$^{-2}$, estimated from the pressure drop across the sill, appears to be generally consistent with energy lost to dissipation and internal wave fluxes.
