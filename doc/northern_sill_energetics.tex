...
Jesse M. Cusack,\aff{a,b,c}
Larry J. Pratt,\aff{d}
James B. Girton,\aff{e}
Glenn S. Carter,\aff{f}
Jody M. Klymak,\aff{g}
Shuwen Tan,\aff{h,i}
 and Andreas M. Thurnherr\aff{h}
}
...
\aff{c}{College of Oceanic and Atmospheric Sciences, Oregon State University, Corvallis, Oregon}
\aff{d}{Woods Hole Oceanographic Institution, Woods Hole, Massachusetts}\\
\aff{e}{Applied Physics Laboratory, University of Washington, Seattle, Washington}\\
\aff{f}{Department of Oceanography, University of Hawaii at M\={a}noa, Honolulu, Hawaii}\\
\aff{g}{University of Victoria, Victoria, British Columbia, Canada}\\
\aff{h}{Lamont-Doherty Earth Observatory, Columbia University, Palisades, New York}\\
\aff{i}{University of California Irvine, Irvine, California}\\
}
